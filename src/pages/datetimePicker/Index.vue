  ...
  <page-wraper>
    ...
    <demo-block transparent>
      <ht-cell-group border>
        <ht-datetime-picker :label="$t('ri-qi-xuan-ze')" v-model="value1" @confirm="handleConfirm1" />
        <ht-datetime-picker :label="$t('nian-yue-ri')" v-model="value2" type="date" @confirm="handleConfirm2" />
        <ht-datetime-picker :label="$t('nian-yue')" v-model="value3" type="year-month" @confirm="handleConfirm3" />
        <ht-datetime-picker :label="$t('nian')" v-model="value16" type="year" @confirm="handleConfirm16" />
        <ht-datetime-picker :label="$t('shi-fen')" v-model="value4" type="time" @confirm="handleConfirm4" />
        <ht-datetime-picker :label="$t('zhan-shi-ge-shi')" v-model="value5" :display-format="displayFormat" @confirm="handleConfirm5" />
        <ht-datetime-picker :label="$t('nei-bu-ge-shi')" v-model="value6" :formatter="formatter" @confirm="handleConfirm6" />
        <ht-datetime-picker :label="$t('guo-lv-xuan-xiang')" v-model="value7" :filter="filter" @confirm="handleConfirm7" />
        <ht-datetime-picker label="before-confirm" v-model="value8" :before-confirm="beforeConfirm" @confirm="handleConfirm8" />
        <ht-datetime-picker :label="$t('cuo-wu')" v-model="value9" error @confirm="handleConfirm9" />
        <ht-datetime-picker :label="$t('bi-tian')" v-model="value10" required @confirm="handleConfirm10" />
        <ht-datetime-picker :label="$t('mo-ren-ri-qi')" v-model="value2" :default-value="value2" />
        <ht-datetime-picker
    ...
    <demo-block :title="$t('label-bu-chuan-0')" transparent>
      <ht-datetime-picker v-model="value11" @confirm="handleConfirm11" />
    </demo-block>
    <demo-block :title="$t('da-xiao')" transparent>
      <ht-datetime-picker :label="$t('ri-qi-xuan-ze-0')" size="large" v-model="value12" @confirm="handleConfirm12" />
    </demo-block>
    <demo-block :title="$t('zhi-kao-you-zhan-shi')" transparent>
      <ht-datetime-picker :label="$t('ri-qi-xuan-ze-1')" align-right v-model="value13" @confirm="handleConfirm13" />
    </demo-block>
    <demo-block :title="$t('qu-yu-xuan-ze')" transparent>
      <ht-datetime-picker :label="$t('ri-qi-xuan-ze-2')" :title="$t('qing-xuan-ze-qu-jian')" v-model="value14" @confirm="handleConfirm14" />
    </demo-block>
...
import type { DatetimePickerViewFilter, DatetimePickerViewFormatter } from '@/uni_modules/ht-ui-uni/components/ht-datetime-picker-view/types'
import type {
  DatetimePickerDisplayFormat,
  DatetimePickerDisplayFormatTabLabel,
  DatetimePickerInstance
} from '@/uni_modules/ht-ui-uni/components/ht-datetime-picker/types'
import { ref } from 'vue'
