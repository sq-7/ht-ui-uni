  ...
  <page-wraper>
    <demo-block :title="$t('jiBenYongFa')" transparent>
      <ht-cell-group border>
        ...
        <ht-cell :title="$t('che-pai-hao-jian-pan')" is-link @click="showKeyBoard(10)" />
    ...
    <ht-keyboard v-model:visible="visible1" @input="onInput" @delete="onDelete"></ht-keyboard>
    <ht-keyboard
      ...
      @delete="onDelete"
    ></ht-keyboard>
    <ht-keyboard v-model:visible="visible3" extra-key="X" :close-text="$t('wan-cheng')" @input="onInput" @delete="onDelete" />
    <ht-keyboard
      ...
      @delete="onDelete"
    ></ht-keyboard>
    <ht-keyboard v-model:visible="visible9" extra-key="." :close-text="$t('wan-cheng')" @input="onInput" @delete="onDelete">
      <template #title>
    ...
    <ht-keyboard v-model:visible="visible6" random-key-order @input="onInput" @delete="onDelete" />
    ...
    <ht-keyboard :modal="true" v-model:visible="visible8" @input="onInput" @delete="onDelete" />

    <ht-keyboard v-model:visible="visible10" mode="car" @input="onInput" @delete="onDelete" />
  </page-wraper>
</template>
