 ...
 * @Description:
 * @FilePath: /ht-ui-uni/src/pages/card/Index.vue
 * 记得注释
-->
<template>
  <page-wraper>
    <view>
      <demo-block :title="$t('ji-ben-shi-yong')" transparent>
        <ht-card :title="$t('jing-ying-fen-xi')">
          {{
            $t(
          ...
          <template #footer>
            <ht-button size="small" plain>{{ $t('cha-kan-xiang-qing') }}</ht-button>
          </template>
        </ht-card>
        <ht-card :title="$t('xin-ding-dan')">
          <view class="content">
            <image
          ...
          <template #footer>
            <ht-button size="small" plain>{{ $t('cha-kan-xiang-qing-0') }}</ht-button>
          </template>
        </ht-card>
      </demo-block>
      <demo-block :title="$t('qu-chu-footer')" transparent>
        <ht-card :title="$t('wang-ming')" type="rectangle">
          <view>
            <image
        ...
        <ht-card type="rectangle">
          ...
          <template #footer>
            <view>
              <ht-button size="small" plain custom-style="margin-right: 8px">{{ $t('ping-jia') }}</ht-button>
              <ht-button size="small">{{ $t('li-ji-shi-yong') }}</ht-button>
            </view>
          </template>
        </ht-card>
      </demo-block>
      <demo-block :title="$t('ju-xing-ka-pian')" transparent>
        <ht-card :title="$t('20200203-fu-wu-dao-qi-0')" type="rectangle">
          <view style="height: 40px" class="content">
            <image
              src="https://img11.360buyimg.com/imagetools/jfs/t1/143248/37/5695/265818/5f3a8546E98d998a4/745897ca9c9e474b.jpg"
              width="40"
          ...
          <template #footer>
            <view>
              <ht-button size="small" plain custom-style="margin-right: 8px">{{ $t('ping-jia-0') }}</ht-button>
              <ht-button size="small">{{ $t('li-ji-shi-yong') }}</ht-button>
            </view>
          </template>
        </ht-card>
        <ht-card type="rectangle">
          ...
          <template #footer>
            <view>
              <ht-button size="small" plain custom-style="margin-right: 8px">{{ $t('ping-jia-1') }}</ht-button>
              <ht-button size="small">{{ $t('li-ji-shi-yong') }}</ht-button>
            </view>
          </template>
        </ht-card>
