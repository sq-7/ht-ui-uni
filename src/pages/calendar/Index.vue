  ...
  <page-wraper>
    ...
    <view style="margin: 20px 0">
      <ht-cell-group border>
        <ht-calendar :label="$t('dan-ge-ri-qi-xuan-ze')" v-model="value1" @confirm="handleConfirm1" />
        <ht-calendar :label="$t('duo-ge-ri-qi-xuan-ze')" type="dates" v-model="value2" @confirm="handleConfirm2" />
        <ht-calendar :label="$t('ri-qi-fan-wei-xuan-ze')" type="daterange" v-model="value3" />
        <ht-calendar :label="$t('ri-qi-shi-jian-xuan-ze')" type="datetime" v-model="value4" />
        <ht-calendar :label="$t('ri-qi-shi-jian-fan-wei-xuan-ze')" type="datetimerange" v-model="value5" />
        <ht-calendar :label="$t('zhou-xuan-ze')" type="week" v-model="value6" />
        <ht-calendar :label="$t('yue-xuan-ze')" type="month" :min-date="minDate" v-model="value7" />
        <ht-calendar :label="$t('zhou-fan-wei-xuan-ze')" :first-day-of-week="1" type="weekrange" v-model="value8" />
        <ht-calendar :label="$t('yue-fan-wei-xuan-ze')" type="monthrange" v-model="value9" />
        <ht-calendar :label="$t('ri-zhou-yue-qie-huan')" :first-day-of-week="1" show-type-switch v-model="value10" />
        <ht-calendar :label="$t('kuai-jie-cao-zuo')" v-model="value16" :show-confirm="false" />
        <ht-calendar :label="$t('ri-qi-ge-shi-hua')" type="daterange" v-model="value11" :formatter="formatter" />
        <ht-calendar
        ...
        />
        <ht-calendar label="before-confirm" v-model="value14" :before-confirm="beforeConfirm" />
      </ht-cell-group>
    </view>
    ...
    <demo-block transparent :title="$t('zi-ding-yi-xuan-ze-qi')">
      <view style="margin: 0 15px">
        ...
        <ht-calendar v-model="value15" use-default-slot @confirm="handleConfirm4">
          <ht-button>{{ $t('xuan-ze-ri-qi') }}</ht-button>
        </ht-calendar>
      </view>
    </demo-block>
    <demo-block :title="$t('zu-jian-shi-li-shi-jian')">
      <ht-button @click="openCalendar">{{ $t('da-kai-ri-li') }}</ht-button>
      <ht-calendar ref="calendarRef" v-model="value17" :with-cell="false" @confirm="handleConfirm5" />
    </demo-block>
  </page-wraper>
  <ht-message-box />
</template>
...
import { dayjs } from '@/uni_modules/ht-ui-uni'
import type { CalendarDayItem, CalendarFormatter } from '@/uni_modules/ht-ui-uni/components/ht-calendar-view/types'
import type { CalendarInstance, CalendarOnShortcutsClickOption } from '@/uni_modules/ht-ui-uni/components/ht-calendar/types'
import { ref } from 'vue'
