<template>
  <page-wraper>
    <demo-block :title="$t('jiBenYongFa')">
      <ht-table :data="dataList" @sort-method="handleSort" :height="400" @row-click="handleRowClick">
        <ht-table-col prop="name" :label="$t('xing-ming')" align="center" width="50%"></ht-table-col>
        <ht-table-col prop="grade" :label="$t('fen-shu')" align="center" width="50%"></ht-table-col>
      </ht-table>
    </demo-block>

    <demo-block :title="$t('wu-bian-kuang')">
      <ht-table :data="dataList" @sort-method="handleSort" :height="400" :border="false" @row-click="handleRowClick">
        <ht-table-col prop="name" :label="$t('xing-ming')" align="center" width="50%"></ht-table-col>
        <ht-table-col prop="grade" :label="$t('fen-shu')" align="center" width="50%"></ht-table-col>
      </ht-table>
    </demo-block>
    ...
    <demo-block :title="$t('wu-ban-ma-wen')">
      <ht-table :data="dataList" @sort-method="handleSort" :height="400" :stripe="false" @row-click="handleRowClick">
        <ht-table-col prop="name" :label="$t('xing-ming')" align="center" width="50%"></ht-table-col>
        <ht-table-col prop="grade" :label="$t('fen-shu')" align="center" width="50%"></ht-table-col>
      </ht-table>
    </demo-block>
    ...
    <demo-block :title="$t('bu-zhan-shi-biao-tou')">
      <ht-table :data="dataList" @sort-method="handleSort" :height="400" :show-header="false" @row-click="handleRowClick">
        <ht-table-col prop="name" :label="$t('xing-ming')" align="center" width="50%"></ht-table-col>
        <ht-table-col prop="grade" :label="$t('fen-shu')" align="center" width="50%"></ht-table-col>
      </ht-table>
    </demo-block>
    ...
    <demo-block :title="$t('gu-ding-lie')">
      <ht-table :data="dataList" @sort-method="handleSort" @row-click="handleRowClick" :height="400">
        <ht-table-col prop="name" :label="$t('xing-ming')" fixed sortable align="center"></ht-table-col>
        <ht-table-col prop="grade" :label="$t('fen-shu')" fixed sortable align="center"></ht-table-col>
        <ht-table-col prop="hobby" :label="$t('yi-yan-yi-bi-zhi')" sortable :width="160"></ht-table-col>
        <ht-table-col prop="school" :label="$t('qiu-xue-zhi-suo')" :width="180"></ht-table-col>
        <ht-table-col prop="major" :label="$t('zhuan-ye')"></ht-table-col>
        <ht-table-col prop="gender" :label="$t('xing-bie')"></ht-table-col>
      </ht-table>
    </demo-block>

    <demo-block :title="$t('xian-shi-suo-yin')">
      <ht-table :data="dataList" :height="400" @sort-method="handleSort" :index="{ align: 'center' }">
        <ht-table-col prop="name" :label="$t('xing-ming')" sortable align="center"></ht-table-col>
        <ht-table-col prop="grade" :label="$t('fen-shu')" sortable align="center"></ht-table-col>
        <ht-table-col prop="hobby" :label="$t('yi-yan-yi-bi-zhi')" sortable :width="160"></ht-table-col>
        <ht-table-col prop="school" :label="$t('qiu-xue-zhi-suo')" :width="180"></ht-table-col>
        <ht-table-col prop="major" :label="$t('zhuan-ye-0')"></ht-table-col>
        <ht-table-col prop="gender" :label="$t('xing-bie')"></ht-table-col>
      </ht-table>
    </demo-block>
    ...
    <demo-block :title="$t('zi-ding-yi-lie-mo-ban')">
      <ht-table :data="dataList" @sort-method="handleSort" @row-click="handleRowClick" :height="400">
        <ht-table-col prop="name" :label="$t('xing-ming')" fixed sortable align="center"></ht-table-col>
        <ht-table-col prop="grade" :label="$t('fen-shu')" fixed sortable align="center">
          <template #value="{ row }">
        ...
        <ht-table-col prop="hobby" :label="$t('yi-yan-yi-bi-zhi')" sortable :width="160"></ht-table-col>
        <ht-table-col prop="school" :label="$t('qiu-xue-zhi-suo')" :width="180"></ht-table-col>
        <ht-table-col prop="major" :label="$t('zhuan-ye-1')"></ht-table-col>
        <ht-table-col prop="gender" :label="$t('xing-bie')"></ht-table-col>
        <ht-table-col prop="graduation" :label="$t('xue-cheng-shi-jian')"></ht-table-col>
      </ht-table>
    </demo-block>

    <demo-block :title="$t('bu-gu-ding-biao-tou-jie-he-fen-ye-qi')">
      <ht-table :data="paginationData" :fixed-header="false">
        <ht-table-col prop="name" :label="$t('xing-ming')" fixed align="center"></ht-table-col>
        <ht-table-col prop="grade" :label="$t('fen-shu')" fixed align="center"></ht-table-col>
        <ht-table-col prop="hobby" :label="$t('yi-yan-yi-bi-zhi')" :width="160"></ht-table-col>
        <ht-table-col prop="school" :label="$t('qiu-xue-zhi-suo')" :width="180"></ht-table-col>
        <ht-table-col prop="major" :label="$t('zhuan-ye-2')"></ht-table-col>
        <ht-table-col prop="gender" :label="$t('xing-bie')"></ht-table-col>
      </ht-table>
...
import type { TableColumn } from '@/uni_modules/ht-ui-uni/components/ht-table-col/types'
