<template>
  <page-wraper>
    <demo-block :title="$t('jiBenYongFa')">
      <ht-rate v-model="value1" @change="changeValue1" />
    </demo-block>

    <demo-block :title="$t('zhi-du-zhuang-tai-readonly')">
      <ht-rate v-model="value2" readonly />
    </demo-block>

    <demo-block :title="$t('jin-yong-zhuang-tai')">
      <ht-rate v-model="value3" disabled />
    </demo-block>

    <demo-block :title="$t('xiu-gai-xuan-zhong-yan-se')">
      <view style="margin-bottom: 10px">
        <ht-rate v-model="value4" active-color="linear-gradient(180deg, rgba(255,238,0,1) 0%,rgba(250,176,21,1) 100%)" @change="changeValue2" />
      </view>
      <ht-rate
        v-model="value5"
        :active-color="[
    ...
    <demo-block :title="$t('xiu-gai-icon-he-xuan-zhong-yan-se')">
      <ht-rate v-model="value6" icon="dong" active-icon="dong" active-color="#4D80F0" />
    </demo-block>

    <demo-block :title="$t('xiu-gai-sizespace')">
      <ht-rate v-model="value7" space="10px" size="30px" />
    </demo-block>

    <demo-block :title="$t('yun-xu-ban-xuan')">
      <ht-rate v-model="value8" allow-half />
    </demo-block>
  </page-wraper>
</template>
