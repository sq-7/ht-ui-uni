    ...
    <page-wraper>
      ...
      <ht-form ref="form" :model="model" :rules="rules">
        <ht-cell-group custom-class="group" :title="$t('ji-chu-xin-xi')" border>
          ...
          />
          <ht-cell prop="threshold" :title="$t('quan-mian-e')" required title-width="100px" custom-value-class="cell-left">
        ...
        <ht-cell-group custom-class="group" :title="$t('shi-jian-he-di-zhi')" border>
          <ht-datetime-picker
            ...
            v-model="model.time"
          />
          <ht-calendar :label="$t('ri-qi')" label-width="100px" :placeholder="$t('qing-xuan-ze-ri-qi')" prop="date" v-model="model.date" />
        ...
        <ht-cell-group custom-class="group" :title="$t('qi-ta-xin-xi')" border>
          <ht-textarea
            ...
            prop="content"
          />
          <ht-cell :title="$t('fa-huo-shu-liang')" title-width="100px" prop="count">
            <view style="text-align: left">
              <ht-input-number v-model="model.count" />
            </view>
          </ht-cell>
          <ht-cell :title="$t('kai-qi-zhe-kou')" title-width="100px" prop="switchVal" center>
            <view style="text-align: left">
          ...
          <ht-input
            ...
            v-model="model.phone"
          />
          <ht-cell :title="$t('huo-dong-tu-pian')" title-width="100px" prop="fileList">
            <ht-upload
...
import { type FormInstance, type FormRules } from '@/uni_modules/ht-ui-uni/components/ht-form/types'
...
@/uni_modules/ht-ui-uni/components/ht-form/type
