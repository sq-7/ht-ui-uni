<template>
  <page-wraper>
    <demo-block :title="$t('ji-chu-biao-dan')" transparent>
      <ht-form ref="form1" :model="model1">
        ...
        <view class="footer">
          <ht-button type="primary" size="large" @click="handleSubmit1" block>{{ $t('ti-jiao') }}</ht-button>
        </view>
      </ht-form>
    </demo-block>

    <demo-block :title="$t('xiao-yan-gui-ze')" transparent>
      <ht-form ref="form2" :model="model2">
        <ht-cell-group border>
          <ht-input
            :label="$t('xiao-yan')"
            label-width="100px"
        ...
        <view class="footer">
          <ht-button type="primary" size="large" @click="handleSubmit2" block>{{ $t('ti-jiao') }}</ht-button>
        </view>
      </ht-form>
    </demo-block>
    ...
    <demo-block :title="$t('dong-tai-biao-dan')" transparent>
      <view class="demo-button">
        <ht-button @click="handleClick1" :round="false" block size="large">{{ $t('dong-tai-biao-dan-0') }}</ht-button>
      </view>
    </demo-block>

    <demo-block :title="$t('shi-jiao-xiao-yan')" transparent>
      <view class="demo-button">
        <ht-button @click="handleClick2" :round="false" block size="large">{{ $t('shi-jiao-xiao-yan-0') }}</ht-button>
      </view>
    </demo-block>

    <demo-block :title="$t('fu-za-biao-dan')" transparent>
      <view class="demo-button">
        <ht-button @click="handleClick3" :round="false" block size="large">{{ $t('fu-za-biao-dan-0') }}</ht-button>
      </view>
    </demo-block>

    <demo-block :title="$t('xiao-yan-ti-shi-fang-shi')" transparent>
      <view class="demo-button">
        <ht-button @click="handleClick4" :round="false" block size="large">{{ $t('xiao-yan-ti-shi-fang-shi') }}</ht-button>
      </view>
    </demo-block>
  </page-wraper>
</template>
