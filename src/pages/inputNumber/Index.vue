<template>
  <page-wraper>
    <demo-block :title="$t('jiBenYongFa')">
      <ht-input-number v-model="value1" @change="handleChange1" />
    </demo-block>
    <demo-block :title="$t('she-zhi-bu-chang')">
      <ht-input-number v-model="value2" @change="handleChange2" :step="2" />
    </demo-block>
    <demo-block :title="$t('xian-zhi-zui-da-zui-xiao-zhi')">
      <ht-input-number v-model="value3" @change="handleChange3" :min="3" :max="10" />
    </demo-block>
    <demo-block :title="$t('jinYong')">
      <ht-input-number v-model="value4" @change="handleChange4" disabled />
    </demo-block>
    <demo-block :title="$t('jin-yong-shu-ru-kuang')">
      <ht-input-number v-model="value10" @change="handleChange4" disable-input />
    </demo-block>
    <demo-block :title="$t('wu-shu-ru-kuang')">
      <view class="flex">
        <view>{{ $t('shu-liang-value5') }}{{ value5 }}</view>
        <ht-input-number v-model="value5" @change="handleChange5" without-input />
      </view>
    </demo-block>
    <demo-block :title="$t('she-zhi-xiao-shu-jing-du')">
      <ht-input-number v-model="value6" @change="handleChange6" :precision="1" :step="0.1" />
    </demo-block>
    <demo-block :title="$t('shu-ru-yan-ge-wei-bu-shu-de-bei-shu')">
      <ht-input-number v-model="value7" @change="handleChange7" step-strictly :step="2" />
    </demo-block>
    <demo-block :title="$t('xiu-gai-shu-ru-kuang-kuan-du')">
      <ht-input-number v-model="value8" input-width="70px" @change="handleChange8" />
    </demo-block>
    <demo-block :title="$t('yun-xu-kong-zhi-bing-she-zhi-placeholder')">
      <ht-input-number v-model="value9" allow-null :placeholder="$t('bu-xian')" input-width="70px" @change="handleChange9" />
    </demo-block>
    <demo-block :title="$t('yi-bu-bian-geng')">
      <ht-input-number v-model="value11" :before-change="beforeChange" />
    </demo-block>
    <demo-block :title="$t('chang-an-jia-jian')">
      <ht-input-number v-model="value12" long-press @change="handleChange12" />
    </demo-block>
  </page-wraper>
</template>
