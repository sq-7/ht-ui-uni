      ...
      <template #footer="{ clear, confirm, restore, revoke, canUndo, canRedo }">
        <view class="custom-actions">
          <view class="button-group">
            <ht-button size="small" plain @click="revoke" :disabled="!canUndo">{{ $t('che-hui') }}</ht-button>
            <ht-button size="small" plain @click="restore" :disabled="!canRedo">{{ $t('hui-fu') }}</ht-button>
            <ht-button size="small" plain @click="clear">{{ $t('qing-chu') }}</ht-button>
            <ht-button size="small" type="primary" @click="confirm">{{ $t('wan-cheng') }}</ht-button>
          </view>
        </view>
      </template>
      <!-- #endif -->
