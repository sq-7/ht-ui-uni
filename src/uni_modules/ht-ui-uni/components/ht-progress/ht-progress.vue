<template>
  <view :class="`ht-progress ${customClass}`" :style="customStyle">
    <view class="ht-progress__outer">
      <view :class="`ht-progress__inner ${innerClass}`" :style="rootStyle"></view>
    </view>
    <view v-if="!hideText" class="ht-progress__label">{{ percentage }}%</view>
    <ht-icon
      v-else-if="status"
      :custom-class="`ht-progress__label ht-progress__icon ${innerClass}`"
      :name="iconName"
