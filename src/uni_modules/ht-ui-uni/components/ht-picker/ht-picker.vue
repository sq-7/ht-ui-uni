<template>
  ...
  >
    <view class="ht-picker__field" @click="showPopup">
      ...
      <view v-else class="ht-picker__cell">
        <view
        ...
        <view class="ht-picker__body">
          <view class="ht-picker__value-wraper">
            <view :class="`ht-picker__value ${ellipsis && 'is-ellipsis'} ${customValueClass} ${showValue ? '' : 'ht-picker__placeholder'}`">
              {{ showValue ? showValue : placeholder || translate('placeholder') }}
            </view>
            <ht-icon v-if="showArrow" custom-class="ht-picker__arrow" name="arrow-right" />
            <view v-else-if="showClear" @click.stop="handleClear">
              <ht-icon custom-class="ht-picker__clear" name="error-fill" />
            </view>
          </view>
    ...
    >
      <view class="ht-picker__wraper">
        <view class="ht-picker__toolbar" @touchmove="noop">
          ...
          <view :class="`ht-picker__action ${isLoading ? 'is-loading' : ''}`" @click="onConfirm">
...
import wdPickerView from '../ht-picker-view/ht-picker-view.vue'
...
import { type ColumnItem, formatArray, type PickerViewInstance } from '../ht-picker-view/types'
