<template>
  <view :class="rootClass" :style="rootStyle" @click="handleClick">
    <view v-if="useIconSlot" class="ht-tag__icon">
      <slot name="icon" />
    </view>
    <ht-icon v-else-if="icon" :name="icon" custom-class="ht-tag__icon" />
    <view class="ht-tag__text" :style="textStyle">
      <slot />
    </view>
    <view class="ht-tag__close" v-if="closable && round" @click.stop="handleClose">
      <ht-icon name="error-fill" />
    </view>
    <input
      v-if="dynamicInput && dynamic"
      class="ht-tag__add-text"
    ...
    />
    <view v-else-if="dynamic" class="ht-tag__text" :style="textStyle" @click.stop="handleAdd">
      <slot name="add" v-if="$slots.add"></slot>
      <template v-else>
        <ht-icon name="add" custom-class="ht-tag__add ht-tag__icon" />
...
const rootClass = computed(() => {
  return `ht-tag ${props.customClass} ${tagClass.value}`
})
