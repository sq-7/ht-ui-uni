<template>
  <view class="ht-curtain-wrapper">
    <ht-popup
      ...
      :custom-class="`ht-curtain ${customClass}`"
      :custom-style="customStyle"
    >
      <view class="ht-curtain__content">
        <image :src="src" class="ht-curtain__content-img" :style="imgStyle" @click="clickImage" @error="imgErr" @load="imgLoad"></image>
        <slot name="close">
          <ht-icon
            name="close-outline"
            :custom-class="`ht-curtain__content-close ${closePosition} ${customCloseClass}`"
