<template>
  <view :class="`ht-segmented ${customClass}`" :style="customStyle">
    <view
      :class="`ht-segmented__item is-${size} ${state.activeIndex === index ? 'is-active' : ''} ${
      ...
      :key="index"
    >
      <view class="ht-segmented__item-label">
    ...
    <view :class="`ht-segmented__item--active ${activeDisabled ? 'is-disabled' : ''}`" :style="state.activeStyle"></view>
  </view>
</template>
