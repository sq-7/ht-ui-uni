<template>
  <view v-if="show" :class="`ht-notice-bar ${customClass} ${noticeBarClass}`" :style="rootStyle">
    <ht-icon v-if="prefix" custom-class="ht-notice-bar__prefix" :name="prefix"></ht-icon>
    <slot v-else name="prefix"></slot>
    <view class="ht-notice-bar__wrap">
      <view class="ht-notice-bar__content" :style="animation" @transitionend="animationEnd" @click="handleClick">
    ...
    <ht-icon v-if="closable" custom-class="ht-notice-bar__suffix" name="close-bold" @click="handleClose"></ht-icon>
...
const $wrap = '.ht-notice-bar__wrap'
const $content = '.ht-notice-bar__content'
...
const noticeBarClass = computed(() => {
  ...
  if (isHorizontal.value) {
    !wrapable && !scrollable && noticeBarClasses.push('ht-notice-bar--ellipse')
  } else {
    noticeBarClasses.push('ht-notice-bar--ellipse')
  }

  wrapable && !scrollable && noticeBarClasses.push('ht-notice-bar--wrap')
