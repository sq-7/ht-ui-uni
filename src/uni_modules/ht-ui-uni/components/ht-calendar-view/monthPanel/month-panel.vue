<template>
  <view class="ht-month-panel">
    <view v-if="showPanelTitle" class="ht-month-panel__title">
      {{ title }}
    </view>
    <view class="ht-month-panel__weeks">
      <view v-for="item in 7" :key="item" class="ht-month-panel__week">{{ weekLabel(item + firstDayOfWeek) }}</view>
    </view>
    <scroll-view
      :class="`ht-month-panel__container ${!!timeType ? 'ht-month-panel__container--time' : ''}`"
    ...
    <view v-if="timeType" class="ht-month-panel__time">
      <view v-if="type === 'datetimerange'" class="ht-month-panel__time-label">
        <view class="ht-month-panel__time-text">{{ timeType === 'start' ? translate('startTime') : translate('endTime') }}</view>
      </view>
      <view class="ht-month-panel__time-picker">
        <ht-picker-view
