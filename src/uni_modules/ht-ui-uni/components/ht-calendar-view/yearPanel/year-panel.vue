<template>
  <view class="ht-year-panel">
    <view v-if="showPanelTitle" class="ht-year-panel__title">{{ title }}</view>
    <scroll-view class="ht-year-panel__container" :style="`height: ${scrollHeight}px`" scroll-y @scroll="yearScroll" :scroll-top="scrollTop">
