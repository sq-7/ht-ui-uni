<template>
  <!-- #ifdef MP-DINGTALK -->
  <view :class="`ht-index-anchor-ding ${isSticky ? 'is-sticky' : ''}`">
    <!-- #endif -->
    <view :class="`ht-index-anchor ${isSticky ? 'is-sticky' : ''} ${customClass}`" :style="customStyle" :id="indexAnchorId">
      <slot>
        {{ index }}
      </slot>
    </view>
...
import { indexBarInjectionKey } from '../ht-index-bar/type'
