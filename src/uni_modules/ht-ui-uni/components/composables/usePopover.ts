...
export function usePopover(visibleArrow = true) {
  ...
  function init(
    ...
    if (visibleArrow) {
      const arrowClassArr = [
        `ht-${selector}__arrow`,
        placement === 'bottom' || placement === 'bottom-start' || placement === 'bottom-end' ? `ht-${selector}__arrow-up` : '',
        placement === 'left' || placement === 'left-start' || placement === 'left-end' ? `ht-${selector}__arrow-right` : '',
        placement === 'right' || placement === 'right-start' || placement === 'right-end' ? `ht-${selector}__arrow-left` : '',
        placement === 'top' || placement === 'top-start' || placement === 'top-end' ? `ht-${selector}__arrow-down` : ''
      ]
