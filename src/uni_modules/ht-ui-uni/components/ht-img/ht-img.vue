 ...
 * @FilePath: \ht-ui-uni\src\uni_modules\ht-ui-uni\components\ht-img\ht-img.vue
 * 记得注释
-->
<template>
  <view :class="rootClass" @click="handleClick" :style="rootStyle">
    <image
      :class="`ht-img__image ${customImage}`"
...
const rootClass = computed(() => {
  return `ht-img  ${props.round ? 'is-round' : ''} ${props.customClass}`
})
