<template>
  <view
    :class="`ht-floating-panel ${customClass} ${safeAreaInsetBottom ? 'is-safe' : ''}`"
    :style="rootStyle"
  ...
  >
    <view :class="`ht-floating-panel__header`">
      <view :class="`ht-floating-panel__header-bar`"></view>
    </view>

    <scroll-view
      :class="`ht-floating-panel__content`"
      data-id="content"
