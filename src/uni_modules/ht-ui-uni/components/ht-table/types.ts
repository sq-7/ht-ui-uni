 ...
 * @Description:
 * @FilePath: /ht-ui-uni/src/uni_modules/ht-ui-uni/components/ht-table/types.ts
 * 记得注释
 */
...
import type { TableColumnProps } from '../ht-table-col/types'
...
export const TABLE_KEY: InjectionKey<TableProvide> = Symbol('ht-table')
