 ...
 * @Description:
 * @FilePath: \ht-ui-uni\src\uni_modules\ht-ui-uni\components\ht-status-tip\types.ts
 * 记得注释
 */
import type { ExtractPropTypes, PropType } from 'vue'
import { baseProps, makeStringProp } from '../common/props'
import type { ImageMode } from '../ht-img/types'
...
export const statusTipProps = {
   ...
   * 类型: string
   * 默认值: https://registry.npmmirror.com/ht-ui-uni-assets/*\/files/
   */
  urlPrefix: makeStringProp('https://registry.npmmirror.com/ht-ui-uni-assets/*/files/')
}
