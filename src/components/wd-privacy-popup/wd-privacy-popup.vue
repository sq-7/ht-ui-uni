<template>
  <view>
    <ht-popup v-model="showPopup" :close-on-click-modal="false" custom-class="ht-privacy-popup" @close="handleClose">
      <view class="ht-privacy-popup__header">
        <!--标题-->
        <view class="ht-picker__title">{{ title }}</view>
      </view>
      <view class="ht-privacy-popup__container">
        <text>{{ desc }}</text>
        <text class="ht-privacy-popup__container-protocol" @click="openPrivacyContract">{{ protocol }}</text>
        <text>{{ subDesc }}</text>
      </view>
      <view class="ht-privacy-popup__footer">
        <ht-button custom-class="ht-privacy-popup__footer-disagree " size="medium" round plain buttonId="disagree-btn" @click="handleDisagree">
          {{ $t('ju-jue') }}
        </ht-button>
        <ht-button
          class="ht-privacy-popup__footer-agree"
          round
          size="medium"
          buttonId="agree-btn"
