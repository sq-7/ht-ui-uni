...
```html
<ht-select-picker label="基本用法" v-model="value" :columns="columns" @change="handleChange"></ht-select-picker>
```
...
```html
<ht-select-picker label="类型切换" v-model="value" :columns="columns" type="radio"></ht-select-picker>
```
...
```html
<ht-select-picker label="禁用" v-model="value" :columns="columns" disabled></ht-select-picker>
```
...
```html
<ht-select-picker label="只读" v-model="value" :columns="columns" readonly></ht-select-picker>
```
...
```html
<ht-select-picker label="清空" v-model="value" :columns="columns" clearable></ht-select-picker>
```
...
```html
<ht-select-picker label="禁用选项" v-model="value" :columns="columns"></ht-select-picker>
```
...
```html
<ht-select-picker label="展示格式化" v-model="value" :columns="columns" :display-format="displayFormat"></ht-select-picker>
```
...
```html
<ht-select-picker label="确定前校验" v-model="value" :columns="columns" :before-confirm="beforeConfirm"></ht-select-picker>
```
...
```html
<ht-select-picker label="标题" v-model="value" :columns="columns" title="多选"></ht-select-picker>
```
...
```html
<ht-select-picker label="错误" v-model="value" :columns="columns" error></ht-select-picker>
```
...
```html
<ht-select-picker label="必填" v-model="value" :columns="columns" required></ht-select-picker>
```
...
```html
<ht-select-picker label="大尺寸" v-model="value" :columns="columns" size="large"></ht-select-picker>
```
...
```html
<ht-select-picker label="值靠右展示" v-model="value" :columns="columns" align-right></ht-select-picker>
```
...
```html
<ht-select-picker label="可搜索" v-model="value" :columns="columns" filterable></ht-select-picker>
```
...
```html
<ht-select-picker label="自动完成" type="radio" :show-confirm="false" v-model="value19" :columns="columns" />
```
...
<ht-select-picker v-model="value" use-default-slot :columns="columns" @confirm="handleConfirm">
  <ht-button>默认唤起项</ht-button>
</ht-select-picker>
```
