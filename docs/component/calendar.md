...
```html
<ht-calendar v-model="value" label="日期选择" @confirm="handleConfirm" />
```
...
```html
<ht-calendar label="日周月切换" :first-day-of-week="1" show-type-switch v-model="value" @confirm="handleConfirm" />
```
...
```html
<ht-calendar label="快捷操作" :show-confirm="false" v-model="value" @confirm="handleConfirm" />
```
...
```html
<ht-calendar type="daterange" v-model="value" allow-same-day :formatter="formatter" @confirm="handleConfirm" />
```
...
<ht-calendar label="before-confirm" v-model="value" :before-confirm="beforeConfirm" />
```
...
```html
<ht-calendar type="daterange" :max-range="3" v-model="value" @confirm="handleConfirm" />
```
...
<ht-calendar v-model="value" @confirm="handleConfirm">
  <ht-button>选择日期</ht-button>
</ht-calendar>
```
...
```html
<ht-button @click="openCalendar">打开日历</ht-button>

<ht-calendar ref="calendar" :with-cell="false" v-model="value" @confirm="handleConfirm" />
```

```typescript
import { ref } from 'vue'
import type { CalendarInstance } from '@/uni_modules/ht-ui-uni/components/ht-calendar/types'
