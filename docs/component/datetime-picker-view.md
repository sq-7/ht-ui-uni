...
<ht-datetime-picker-view v-model="value" label="日期选择" @change="handleChange" />
```
```typescript
...
```html
<ht-datetime-picker-view type="date" v-model="value" label="年月日" />
```
```typescript
const value = ref<number>(Date.now())
```
...
```html
<ht-datetime-picker-view type="year-month" v-model="value" label="年月" />
```
```typescript
const value = ref<number>(Date.now())
```
...
```html
<ht-datetime-picker-view type="year" v-model="value" label="年" />
```
```typescript
const value = ref<number>(Date.now())
```
...
```html
<ht-datetime-picker-view type="time" v-model="value" label="时分" />
```
```typescript
...
```html
<ht-datetime-picker-view v-model="value" label="内部格式" :formatter="formatter" />
```
...
```html
<ht-datetime-picker-view v-model="value" label="过滤选项" :filter="filter" />
```
```typescript
const value = ref<number>(Date.now())
