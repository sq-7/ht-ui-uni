...
```html
<ht-textarea v-model="value" placeholder="请填写评价" />
```
...
<ht-cell-group border>
  <ht-textarea label="基本用法" clearable v-model="value" placeholder="请输入..." />
</ht-cell-group>
```
...
```html
<ht-textarea v-model="value" placeholder="请输入..." label="必填" required></ht-textarea>
```
...
```html
<ht-textarea label="基本用法" size="large" v-model="value" placeholder="请输入..." />
```
...
```html
<ht-textarea v-model="value" placeholder="请输入用户名" error />
```
...
```html
<ht-textarea label="基本用法" v-model="value" center />
```
