...
```html
<ht-datetime-picker v-model="value" label="日期选择" @confirm="handleConfirm" />
```
...
```html
<ht-datetime-picker v-model="value" :default-value="defaultValue" label="日期选择" @confirm="handleConfirm" />
```
...
```html
<ht-datetime-picker type="date" v-model="value" label="年月日" />
```
```typescript
...
```html
<ht-datetime-picker type="year-month" v-model="value" label="年月" />
```
```typescript
const value = ref<number>(Date.now())
```
...
```html
<ht-datetime-picker type="year" v-model="value" label="年" />
```
```typescript
const value = ref<number>(Date.now())
```
...
```html
<ht-datetime-picker type="time" v-model="value" label="时分" />
```
```typescript
...
```html
<ht-datetime-picker v-model="value" label="展示格式" :displayFormat="displayFormat" />
```
```typescript
const value = ref<number>(Date.now())
...
```html
<ht-datetime-picker v-model="value" label="内部格式" :formatter="formatter" />
```
```typescript
const value = ref<number>(Date.now())
...
```html
<ht-datetime-picker v-model="value" label="过滤选项" :filter="filter" />
```
```typescript
const value = ref<number>(Date.now())
...
```html
<ht-datetime-picker label="日期选择" size="large" v-model="value" />
```
...
```html
<ht-datetime-picker label="必填属性" error v-model="value" required/>
```
...
```html
<ht-datetime-picker label="日期选择" error v-model="value" />
```
...
```html
<ht-datetime-picker label="日期选择" align-right v-model="value" />
```
...
```html
<ht-datetime-picker label="日期选择" v-model="value" @confirm="handleConfirm" />
...
```html
<ht-datetime-picker v-model="value" label="范围tab展示格式" :display-format-tab-label="displayFormatTabLabel" @confirm="handleConfirm"></ht-datetime-picker>
```
