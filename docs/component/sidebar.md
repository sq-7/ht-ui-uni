...
<ht-sidebar v-model="active">
  <ht-sidebar-item :value="0" label="标签名称" />
  <ht-sidebar-item :value="1" label="标签名称" />
  <ht-sidebar-item :value="2" label="标签名称" />
</ht-sidebar>
```
...
```html
<ht-sidebar v-model="active">
  <ht-sidebar-item :value="0" label="标签名称" is-dot />
  <ht-sidebar-item :value="1" label="标签名称" badge="5" />
  <ht-sidebar-item :value="2" label="标签名称" />
</ht-sidebar>
```
...
<ht-sidebar v-model="active">
  <ht-sidebar-item :value="0" label="标签名称" />
  <ht-sidebar-item :value="1" label="标签名称" disabled />
  <ht-sidebar-item :value="2" label="标签名称" />
</ht-sidebar>
```
...
<ht-sidebar v-model="active" @change="handleChange">
  <ht-sidebar-item :value="0" label="标签名称 1" />
  <ht-sidebar-item :value="1" label="标签名称 2" />
  <ht-sidebar-item :value="2" label="标签名称 3" />
</ht-sidebar>
```
