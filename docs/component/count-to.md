...
```vue
<ht-count-to :endVal="2024" suffix="年" color="#16baaa"></ht-count-to>
...
<ht-grid clickable border>
  <ht-grid-item text="开始" icon="play-circle-stroke" @itemclick="start" />
  <ht-grid-item text="暂停" icon="pause-circle" @itemclick="pause" />
  <ht-grid-item text="重置" icon="refresh" @itemclick="reset" />
</ht-grid>
```
