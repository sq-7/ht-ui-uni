...
```html
<ht-cell title="标题文字" value="内容" />

<ht-cell-group>
  <ht-cell title="标题文字" value="内容" />
  <ht-cell title="标题文字" label="描述信息" value="内容" />
</ht-cell-group>
```
...
```html
<ht-cell-group>
  <ht-cell title="标题文字" value="内容" icon="setting" />
  <ht-cell title="标题文字" value="内容">
    <template #icon>
...
```html
<ht-cell-group title="交易管理" value="内容">
  <ht-cell title="标题文字" value="内容" />
  <ht-cell title="标题文字" label="描述信息" value="内容" />
</ht-cell-group>
```
...
```html
<ht-cell size="large" title="标题文字" value="内容" />
```

## 展示边框线

在 `ht-cell-group` 上设置 `border` 属性，会给每个 cell 加上边框，最后一个 cell 则不展示边框，其他具有 `cell` 类型的表单组件也支持边框展示，如 input、picker。

```html
<ht-cell-group title="交易管理" border>
  <ht-cell title="标题文字" value="内容" />
  <ht-cell :border="false" title="标题文字" label="这一个cell不想要边框" value="内容" />
  <ht-cell title="标题文字" label="描述信息" value="内容"></ht-cell>
</ht-cell-group>
```
...
```html
<ht-toast />
<ht-cell title="标题文字" value="内容" clickable @click="toast" />
```
...
```html
<ht-cell title="帮助与反馈" is-link to="/pages/index/index" />
<ht-cell title="设置" value="内容" is-link to="/pages/button/index" replace></ht-cell>
```

可以只设置 `is-link` 用于展示右箭头和点击态。

```html
<ht-cell title="帮助与反馈" is-link></ht-cell>
```
...
```html
<ht-cell title="标题文字" value="内容" center></ht-cell>
```
...
```html
<ht-cell title="必填" required>
  <ht-rate v-model="rate" change="handleRateChange"></ht-rate>
</ht-cell>
```
...
```html
<ht-cell title="上下结构" vertical>
  <ht-slider v-model="slider" change="handleSliderChange"></ht-slider>
</ht-cell>
```
...
```html
<ht-cell title="标题文字" label="这里是文字描述这里是文字描述这里是文字描述" title-width="200px" value="内容" />
```
...
```html
<ht-cell-group>
  <ht-cell title="标题文字" center>
    <ht-button custom-class="custom-value" size="small" plain>按钮</ht-button>
  </ht-cell>
  <ht-cell title="标题文字" center>
  ...
  <ht-cell title="标题文字" is-link to="/pages/index/index">
