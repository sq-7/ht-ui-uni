...
```html
<ht-button>主要按钮</ht-button>
<ht-button type="success">成功按钮</ht-button>
<ht-button type="info">信息按钮</ht-button>
<ht-button type="warning">警告按钮</ht-button>
<ht-button type="error">危险按钮</ht-button>
```
...
```html
<ht-button disabled>默认按钮</ht-button>
```
...
```html
<ht-button plain>主要按钮</ht-button>
```
...
```html
<ht-button plain hairline>主要按钮</ht-button>
```
...
```html
<ht-button size="small">小号按钮</ht-button>
<ht-button size="medium">中号按钮</ht-button>
<ht-button size="large">大号按钮</ht-button>
```
...
```html
<ht-button loading>加载中</ht-button>
```
...
```html
<ht-button classPrefix="fish" icon="kehuishouwu">可回收</ht-button>
```
...
```html
<ht-button block>主要按钮</ht-button>
```
...
<view class="page-class">
  <ht-button custom-class="custom-shadow">主要按钮</ht-button>
  <ht-button type="success" custom-class="custom-shadow">成功按钮</ht-button>
  <ht-button type="info" custom-class="custom-shadow">信息按钮</ht-button>
  <ht-button type="warning" custom-class="custom-shadow">警告按钮</ht-button>
  <ht-button type="error" custom-class="custom-shadow">危险按钮</ht-button>
</view>
```
...
| classPrefix            | 类名前缀，用于使用自定义图标，参见[icon](/component/icon#自定义图标)                                                                                           | string      | -                                                        | 'ht-icon'    | 0.1.27   |
