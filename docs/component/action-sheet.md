...
```html
<ht-toast />
<ht-button @click="showActions">弹出菜单</ht-button>
<ht-action-sheet v-model="show" :actions="actions" @close="close" @select="select" />
```
...
```html
<ht-button @click="showActions">弹出菜单</ht-button>
<ht-action-sheet v-model="show" :actions="actions" @close="close" />
```
...
```html
<ht-action-sheet v-model="show" :actions="actions" @close="close" cancel-text="取消" />
```
...
```html
<ht-button @click="showActions">弹出菜单</ht-button>
<ht-action-sheet v-model="show" :panels="panels" @close="close" @select="select" />
```
...
```html
<ht-action-sheet v-model="show" title="标题" @close="close">
