...
<ht-collapse v-model="value">
  <ht-collapse-item title="标签1" name="item1">这是一条简单的示例文字。</ht-collapse-item>
  <ht-collapse-item title="标签2" name="item2">这是一条简单的示例文字。</ht-collapse-item>
...
<ht-collapse v-model="value" accordion>
  <ht-collapse-item title="标签1" name="item1">这是一条简单的示例文字。</ht-collapse-item>
  <ht-collapse-item title="标签2" name="item2">这是一条简单的示例文字。</ht-collapse-item>
  <ht-collapse-item title="标签3" name="item3">这是一条简单的示例文字。</ht-collapse-item>
</ht-collapse>
```
...
<ht-collapse v-model="value">
  <ht-collapse-item title="标签1" name="item1">这是一条简单的示例文字。</ht-collapse-item>
  <ht-collapse-item title="标签2" name="item2" disabled>这是一条简单的示例文字。</ht-collapse-item>
  <ht-collapse-item title="标签3" name="item3">这是一条简单的示例文字。</ht-collapse-item>
</ht-collapse>
```
...
通过给`ht-collapse-item`组件传入 `beforeExpend` 函数可以在打开面板前进行校验和处理，返回 true 表示允许打开，返回 false 表示禁止打开。支持返回 Promise 进行例如调用接口获取面板数据的操作。
...
<view class="collapse">
  <ht-collapse v-model="collapseRoot">
    <ht-collapse-item custom-body-style="padding:0 0 0 14px" v-for="item in 5" :key="item" :title="`标签${item}`" :name="`${item}`">
...
```html
<ht-collapse ref="collapse">...</ht-collapse>
```
