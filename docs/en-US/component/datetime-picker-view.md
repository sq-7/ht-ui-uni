...
<ht-datetime-picker-view v-model="value" label="Date Selection" @change="handleChange" />
```
```typescript
...
```html
<ht-datetime-picker-view type="date" v-model="value" label="Year Month Day" />
```
```typescript
const value = ref<number>(Date.now())
```
...
```html
<ht-datetime-picker-view type="year-month" v-model="value" label="Year Month" />
```
```typescript
const value = ref<number>(Date.now())
```
...
```html
<ht-datetime-picker-view type="year" v-model="value" label="Year" />
```
```typescript
const value = ref<number>(Date.now())
```
...
```html
<ht-datetime-picker-view type="time" v-model="value" label="Hour Minute" />
```
```typescript
...
```html
<ht-datetime-picker-view v-model="value" label="Internal Format" :formatter="formatter" />
```
...
```html
<ht-datetime-picker-view v-model="value" label="Filter Options" :filter="filter" />
```
```typescript
const value = ref<number>(Date.now())
