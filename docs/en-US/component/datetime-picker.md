...
```html
<ht-datetime-picker v-model="value" label="Date Selection" @confirm="handleConfirm" />
```
...
```html
<ht-datetime-picker v-model="value" :default-value="defaultValue" label="Date Selection" @confirm="handleConfirm" />
```
...
```html
<ht-datetime-picker type="date" v-model="value" label="Year Month Day" />
```
```typescript
const value = ref<number>(Date.now())
```
...
```html
<ht-datetime-picker type="year-month" v-model="value" label="Year Month" />
```
```typescript
const value = ref<number>(Date.now())
```
...
```html
<ht-datetime-picker type="year" v-model="value" label="Year" />
```
```typescript
const value = ref<number>(Date.now())
```
...
```html
<ht-datetime-picker type="time" v-model="value" label="Hour Minute" />
```
```typescript
...
```html
<ht-datetime-picker v-model="value" label="Display Format" :displayFormat="displayFormat" />
```
```typescript
const value = ref<number>(Date.now())
...
```html
<ht-datetime-picker v-model="value" label="Internal Format" :formatter="formatter" />
```
```typescript
const value = ref<number>(Date.now())
...
```html
<ht-datetime-picker v-model="value" label="Filter Options" :filter="filter" />
```
```typescript
const value = ref<number>(Date.now())
...
```html
<ht-datetime-picker label="Date Selection" size="large" v-model="value" />
```
...
```html
<ht-datetime-picker label="Required Attribute" error v-model="value" required/>
```
...
```html
<ht-datetime-picker label="Date Selection" error v-model="value" />
```
...
```html
<ht-datetime-picker label="Date Selection" align-right v-model="value" />
```
...
```html
<ht-toast></ht-toast>
<ht-datetime-picker label="before-confirm" v-model="value" :before-confirm="beforeConfirm" @confirm="handleConfirm" />
```
...
```html
<ht-datetime-picker v-model="value">
  <ht-button>Trigger with Slot</ht-button>
</ht-datetime-picker>
```
...
```html
<ht-datetime-picker label="Date Selection" v-model="value" @confirm="handleConfirm" />
```
...
```html
<ht-datetime-picker v-model="value" label="Range Tab Display Format" :display-format-tab-label="displayFormatTabLabel" @confirm="handleConfirm"></ht-datetime-picker>
```
...
| rules | Form validation rules, used with `ht-form` component | `FormItemRule []` | - | `[]` | - |
