...
export default defineConfig({
  ...
  title: `Ht Ui Uni`,
  description: '一个参照ht-design打造的uni-app组件库',
  locales: {
    root: {
      label: '简体中文',
      lang: 'zh-CN',
  ...
  themeConfig: {
    ...
    search: {
      ...
      options: {
        appId: 'E8CD8TAF23',
        apiKey: '94d702e153b7b50d355670e95f259238',
        indexName: 'htuiuni',
      },
    },
